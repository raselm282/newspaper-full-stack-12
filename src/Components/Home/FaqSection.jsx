    ...
    <div>
      ...
      <div className="collapse collapse-plus bg-base-200 dark:bg-gray-900 dark:text-white">
        ...
        <div className="collapse-content dark:bg-gray-900 dark:text-white">
          <p>
            I specialize in full-stack web development, with expertise in React,
            Tailwind CSS, Node.js, Express, MongoDB, and Firebase. I also have
            experience with authentication, API integration, and responsive
            design to build modern, scalable web applications.
          </p>
        </div>
      </div>
      <div className="collapse collapse-plus bg-base-200 dark:bg-gray-900 dark:text-white">
      ...
      <div className="collapse collapse-plus bg-base-200 dark:bg-gray-900 dark:text-white">
        ...
        <div className="collapse-content dark:bg-gray-900 dark:text-white">
          <p>
            ...
            collaborations. Whether you need a website, web app, or full-stack
            solution, feel free to reach out to discuss your project. Let me
            know if you want me to customize these further! 🚀
          </p>
        </div>
      </div>
    </div>
